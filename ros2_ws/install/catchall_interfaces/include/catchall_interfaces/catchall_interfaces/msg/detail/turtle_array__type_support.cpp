...
{
  new (message_memory) catchall_interfaces::msg::TurtleArray(_init);
}

void TurtleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<catchall_interfaces::msg::TurtleArray *>(message_memory);
  typed_message->~TurtleArray();
}

size_t size_function__TurtleArray__turtles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<catchall_interfaces::msg::Turtle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<catchall_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<catchall_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const catchall_interfaces::msg::Turtle *>(
    get_const_function__TurtleArray__turtles(untyped_member, index));
  auto & value = *reinterpret_cast<catchall_interfaces::msg::Turtle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<catchall_interfaces::msg::Turtle *>(
    get_function__TurtleArray__turtles(untyped_member, index));
  const auto & value = *reinterpret_cast<const catchall_interfaces::msg::Turtle *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurtleArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<catchall_interfaces::msg::Turtle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(catchall_interfaces::msg::TurtleArray, turtles),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TurtleArray_message_members = {
  "catchall_interfaces::msg",  // message namespace
  "TurtleArray",  // message name
  1,  // number of fields
  sizeof(catchall_interfaces::msg::TurtleArray),
...
get_message_type_support_handle<catchall_interfaces::msg::TurtleArray>()
{
  return &::catchall_interfaces::msg::rosidl_typesupport_introspection_cpp::TurtleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catchall_interfaces, msg, TurtleArray)() {
  return &::catchall_interfaces::msg::rosidl_typesupport_introspection_cpp::TurtleArray_message_type_support_handle;
}
