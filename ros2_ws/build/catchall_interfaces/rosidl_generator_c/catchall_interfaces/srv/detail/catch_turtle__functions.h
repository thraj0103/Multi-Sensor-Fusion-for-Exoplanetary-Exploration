...
#ifndef CATCHALL_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
#define CATCHALL_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
 ...
 * calls
 * catchall_interfaces__srv__CatchTurtle_Request__init().
...
/**
 * It calls
 * catchall_interfaces__srv__CatchTurtle_Request__fini()
 ...
 * catchall_interfaces__srv__CatchTurtle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * catchall_interfaces__srv__CatchTurtle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * catchall_interfaces__srv__CatchTurtle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_catchall_interfaces
...
/**
 * It calls
 * catchall_interfaces__srv__CatchTurtle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_catchall_interfaces
...
/**
 * It allocates the memory for the array and calls
 * catchall_interfaces__srv__CatchTurtle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_catchall_interfaces
...
/**
 * It calls
 * catchall_interfaces__srv__CatchTurtle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CATCHALL_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
