...
static const _CatchTurtle_Request_type_support_symbol_names_t _CatchTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, catchall_interfaces, srv, CatchTurtle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, catchall_interfaces, srv, CatchTurtle_Request)() {
  return &::catchall_interfaces::srv::rosidl_typesupport_c::CatchTurtle_Request_message_type_support_handle;
}
...
static const _CatchTurtle_Response_type_support_symbol_names_t _CatchTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, catchall_interfaces, srv, CatchTurtle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, catchall_interfaces, srv, CatchTurtle_Response)() {
  return &::catchall_interfaces::srv::rosidl_typesupport_c::CatchTurtle_Response_message_type_support_handle;
}
...
static const _CatchTurtle_type_support_symbol_names_t _CatchTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, catchall_interfaces, srv, CatchTurtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, catchall_interfaces, srv, CatchTurtle)() {
  return &::catchall_interfaces::srv::rosidl_typesupport_c::CatchTurtle_service_type_support_handle;
}
