...
#include "catchall_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const catchall_interfaces::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  catchall_interfaces::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = catchall_interfaces::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const catchall_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<catchall_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &catchall_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catchall_interfaces, msg, Turtle)() {
  return &catchall_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
