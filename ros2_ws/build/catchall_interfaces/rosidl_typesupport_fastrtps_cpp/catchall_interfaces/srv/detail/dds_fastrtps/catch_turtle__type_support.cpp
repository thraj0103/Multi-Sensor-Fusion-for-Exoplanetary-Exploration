...
#include "catchall_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const catchall_interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  catchall_interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = catchall_interfaces::srv::CatchTurtle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const catchall_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<catchall_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_catchall_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<catchall_interfaces::srv::CatchTurtle_Request>()
{
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catchall_interfaces, srv, CatchTurtle_Request)() {
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_catchall_interfaces
cdr_serialize(
  const catchall_interfaces::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  catchall_interfaces::srv::CatchTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = catchall_interfaces::srv::CatchTurtle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const catchall_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<catchall_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catchall_interfaces, srv, CatchTurtle_Response)() {
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catchall_interfaces, srv, CatchTurtle)() {
  return &catchall_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
