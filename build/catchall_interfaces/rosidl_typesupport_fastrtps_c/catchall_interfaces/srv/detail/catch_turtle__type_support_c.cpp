...
#include "catchall_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_c.h"
...
#include "catchall_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CatchTurtle_Request__ros_msg_type = catchall_interfaces__srv__CatchTurtle_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catchall_interfaces
size_t get_serialized_size_catchall_interfaces__srv__CatchTurtle_Request(
  const void * untyped_ros_message,
...
static uint32_t _CatchTurtle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_catchall_interfaces__srv__CatchTurtle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catchall_interfaces
size_t max_serialized_size_catchall_interfaces__srv__CatchTurtle_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = catchall_interfaces__srv__CatchTurtle_Request;
    is_plain =
      (
...
static size_t _CatchTurtle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_catchall_interfaces__srv__CatchTurtle_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle_Request)() {
...
using _CatchTurtle_Response__ros_msg_type = catchall_interfaces__srv__CatchTurtle_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catchall_interfaces
size_t get_serialized_size_catchall_interfaces__srv__CatchTurtle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CatchTurtle_Response__ros_msg_type * ros_message = static_cast<const _CatchTurtle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_catchall_interfaces__srv__CatchTurtle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_catchall_interfaces
size_t max_serialized_size_catchall_interfaces__srv__CatchTurtle_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = catchall_interfaces__srv__CatchTurtle_Response;
    is_plain =
      (
...
static size_t _CatchTurtle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_catchall_interfaces__srv__CatchTurtle_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle_Response)() {
...
// already included above
// #include "catchall_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "catchall_interfaces/srv/catch_turtle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, catchall_interfaces, srv, CatchTurtle)() {
