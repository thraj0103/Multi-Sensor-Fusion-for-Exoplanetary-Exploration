...
#include "catchall_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const catchall_interfaces::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  catchall_interfaces::msg::Turtle &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: turtles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      catchall_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  catchall_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      catchall_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        catchall_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        catchall_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = catchall_interfaces::msg::TurtleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const catchall_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<catchall_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &catchall_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
